 ...
 */
class relationsbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "relations@relations";
    public $boxlabel;
    public $depends = array("relations");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/relations/class/relations.class.php";
